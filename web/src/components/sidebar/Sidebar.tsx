...
export function Sidebar() {
  ...
  const settingsButtonClass = route.startsWith("settings")
    ? `${sidebarActionClass} ${sidebarItemActiveClass}`
    : sidebarActionClass;
  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      {/* New chat */}
      <div className={`${sidebarSectionClass} pt-1`}>
        <button
          type="button"
      ...
      <div className={`${sidebarSectionClass} mt-auto w-full space-y-1 border-t border-base-300 pt-2`}>
        <button
          type="button"
          className={`${settingsButtonClass} is-drawer-close:tooltip is-drawer-close:tooltip-right`}
          data-tip="設定"
